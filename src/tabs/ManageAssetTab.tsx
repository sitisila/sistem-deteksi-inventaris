...
const ManageAssetTab: React.FC<ManageAssetTabProps> = ({ 
  currentUser, setIsAddAssetOpen, searchTerm, setSearchTerm, 
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="relative group">
        <input 
          type="text"
          placeholder="Cari seluruh aset laboratorium / ruangan..."
      ...
      {/* 🛡️ DIKUNCI: Hanya akan merender modal saat data selected benar-benar sudah masuk */}
